...
```
- npm install
- node --experimental-modules utils/streams.mjs --action=reverse
    write string you want to reverse into REPL and press ENTER
- node --experimental-modules utils/streams.mjs --action=transform
    write string you want to transform into REPL and press ENTER
